...
- NASA's first biodiversity-focused field campaign
...
.pull-right[.footnote[The mixed pixel problem...]]
...
Using trait maps to infer the legacy impacts of invasive alien plants.
...
Using traits to map landscape flammability.
...
## Very high resolution multispectral data?
...
Cedar decadal resurvey with 2022 imagery...
...
- Joint model of occurrence and mortality
...
.footnote[Prevôst and Slingsby _in prep_]
...
A bit of a holy grail for remote sensing of biodiversity is to be able to map genetic variation, which would be a game changer for conservation and evolutionary biology.
...
knitr::include_graphics("images/spectrometer.jpg")
knitr::include_graphics("images/cedarspectra.png")
```

.footnote[Leaf level spectra show promising differences between morphs.]
]

.pull-right[
```{r echo = F, fig.align = 'center', out.width = '98%'}
knitr::include_graphics("images/cedarunmixing.png")
```

.footnote[Mapping from imagery does not (Prevôst 2025, _Honours_).]
]
...
## Mapping _**milkwoods**_ with hyperspectral imagery

.pull-left[

```{r echo = F, fig.align = 'center', out.width = '40%'}
knitr::include_graphics("images/milkwoodleaves.png")
knitr::include_graphics("images/milkwooddistribution.png")
knitr::include_graphics("images/milkwoodunderstorey.png")
```
...
knitr::include_graphics("images/ANG_Agulhas.png")
```

- Easier to measure (leaf and canopy)
- Larger distribution (and potential for variation)
- Extensive hyperspectral imagery from BioSCape

.footnote[Tallulah Glasby (PhD student)]
]
